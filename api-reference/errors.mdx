---
title: "Praxa API Error Codes and Problem Details"
sidebarTitle: "Errors"
description: "Praxa API errors follow RFC 9457 problem+json format. Learn what each HTTP status code means, how to read the problem detail, and how to recover from common errors."
---
...
| `503` | Service Unavailable | Gateway temporarily unavailable | Retry with exponential backoff |
