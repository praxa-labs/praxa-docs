...
description: "GET /v8/coverage returns a reference coverage report showing which Praxa API endpoints and capabilities are available on your Integration Gateway deployment."
---
