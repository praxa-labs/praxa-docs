...
description: "POST /v8/capabilities/search returns a list of capabilities matching your requirement string. Use this to discover what actions are available before submitting a mission."
---
