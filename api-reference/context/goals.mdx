---
title: "GET /v8/context-twin/goals — List Active Context Goals"
...
keywords: ["Praxa GET /v8/context-twin/goals — List Active Context Goals","Praxa API reference","Praxa Integration Gateway","OAuth API"]
---
