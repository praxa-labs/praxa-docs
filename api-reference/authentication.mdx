---
title: "Authenticate Praxa API Requests with OAuth Tokens"
sidebarTitle: "Authentication"
description: "The Praxa API uses OAuth 2.0 Bearer tokens. Pass your short-lived access token in the Authorization header on every request. Tokens are scoped per operation."
---
