---
title: "GET /v8/world-model/certificates — List World Certificates"
...
keywords: ["Praxa GET /v8/world-model/certificates — List World Certificates","Praxa API reference","Praxa Integration Gateway","OAuth API"]
---
