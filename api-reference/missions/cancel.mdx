...
description: "POST /v8/missions/{runId}/cancel requests cancellation of a running or pending Praxa mission. The mission status transitions to CANCELLED after the current step completes."
---
