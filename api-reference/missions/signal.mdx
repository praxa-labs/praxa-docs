...
description: "POST /v8/missions/{runId}/signals sends a named signal with a JSON payload to a Praxa mission, enabling mid-flight user input or workflow injection."
keywords: ["Praxa POST /v8/missions/{runId}/signals — Send a Mission Signal","Praxa API reference","Praxa Integration Gateway","OAuth API"]
---
