---
title: "POST /v8/missions — Create a New Agent Mission"
sidebarTitle: "Create Mission"
description: "POST /v8/missions creates a new governed AI agent mission. Accepts a goal specification and resource budget. Requires missions:write scope and an Idempotency-Key header."
---
