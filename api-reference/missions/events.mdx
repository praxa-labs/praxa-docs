...
description: "GET /v8/missions/{runId}/events streams real-time Server-Sent Events for a running mission. Returns a text/event-stream that closes when the mission reaches a terminal state."
---
