---
title: "Praxa MCP Tools: Reference for All 11 Tool Definitions"
sidebarTitle: "MCP Tools"
description: "Reference for all 11 Praxa MCP tools: input schemas, OAuth scopes, HTTP paths, and idempotency behavior for the Praxa Integration Gateway."
---
