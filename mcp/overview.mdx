...
description: "@praxa/mcp-contracts provides MCP 2025-03-26 tool definitions for Praxa. Use these contracts to register Praxa tools with any MCP-compatible AI agent server."
---
