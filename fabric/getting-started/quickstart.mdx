...
> personal key in the signed-in console at
> [`https://platform.praxa.io`](https://platform.praxa.io) (password or Google
> sign-in; key creation requires MFA step-up). The console publishes a
> deployment receipt at `/api/deploy-version`.
