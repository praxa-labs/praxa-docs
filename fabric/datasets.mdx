...
> **Status:** Activation-gated. The developer console's dataset surfaces —
> immutable revisions and items with SHA-256 receipts, revision-addressable
> exports, and resumable server-validated JSONL ingest — are deployed at
> `https://platform.praxa.io`. Remaining shared-database production canaries
> (cross-organization isolation, retention, and receipt binding) gate
> organization-scope and production claims; the status page records that
