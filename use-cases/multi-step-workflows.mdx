...
keywords: ["Build Multi-Step AI Agent Workflows with Praxa Missions","Praxa use cases","AI agent workflows","business automation"]
---
...
<Card title="Run a complete mission lifecycle" icon="graduation-cap" href="/tutorials/mission-lifecycle">
  Create a budgeted mission, consume resumable events, signal or cancel it,
  and verify the final projection from Node.js, Next.js, or Express.
</Card>
