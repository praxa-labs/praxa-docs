...
keywords: ["Integrate Praxa Capabilities with MCP-Compatible Agents","Praxa use cases","AI agent workflows","business automation"]
---
...
<Card title="Add Praxa tools to an agent" icon="graduation-cap" href="/tutorials/mcp-tools">
  Register the exact 12 published wire contracts in a Vercel AI SDK, OpenAI,
  LangChain, or framework-neutral host and test schema fidelity.
</Card>
