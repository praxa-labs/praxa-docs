...
description: "Add Praxa to any MCP-compatible agent with @praxa/mcp-contracts. Get typed tool definitions, input schemas, and OAuth scopes for all 11 Praxa operations."
---
