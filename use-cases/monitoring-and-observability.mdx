...
keywords: ["Monitor and Observe Your Praxa Agent Missions in Real Time","Praxa use cases","AI agent workflows","business automation"]
---
...
<Card title="Add and test observability" icon="graduation-cap" href="/tutorials/observability">
  Correlate v1 run polling, SSE, usage, and webhook delivery status with the
  separate Integration Gateway trace and coverage contracts.
</Card>
