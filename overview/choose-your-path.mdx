...
<CardGroup cols={2}>
  <Card title="Node.js or TypeScript" icon="node-js" href="/sdk/overview">
  ...
  <Card title="Python and FastAPI" icon="python" href="/tutorials/fastapi">
    Submit and verify durable tasks from an async Python backend.
  </Card>
