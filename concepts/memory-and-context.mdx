...
keywords: ["Memory, Context, and World Model in Praxa Missions","Praxa concepts","governed AI agents","agent architecture"]
---
...
<Warning>
  ...
  and from the deployed `/v1/memory/*` candidate plane whose authenticated qualification remains
  pending. None of those surfaces creates a managed provider connection in the Developer Platform.
</Warning>
