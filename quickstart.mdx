---
title: "Mission SDK quickstart"
sidebarTitle: "Mission quickstart"
description: "Install the Praxa TypeScript SDK, configure a deployment-specific Integration Gateway, and run a governed mission with Node.js 20 or later."
keywords: ["Praxa Mission SDK quickstart","Praxa developer platform","governed AI agents","Praxa documentation"]
---
...
<Note>
  This quickstart uses a deployment-specific Integration Gateway and OAuth
  token. To call the personal-tenant `api.praxa.io/v1` task API with a Platform
  key, follow [Run and verify a durable task](/tutorials/durable-tasks).
</Note>
