...
description: "Full reference for Praxa CLI commands: init, version, doctor, and mission submit, get, create, and cancel."
---
...
```json
{
  ...
  "contractVersion": "praxa-integration-gateway-v8.1",
