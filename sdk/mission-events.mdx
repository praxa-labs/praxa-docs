---
title: "Stream Mission Events with Praxa SSE"
sidebarTitle: "Mission Events"
description: "missionEvents() returns an async generator that streams Server-Sent Events from a running Praxa mission in real time. Learn how to consume, filter, and handle mission event streams."
---
