---
title: "Praxa TypeScript SDK: @praxa/sdk Overview"
sidebarTitle: "Overview"
description: "@praxa/sdk is the official TypeScript client for the Praxa Integration Gateway. Install it to submit missions, stream events, and query capabilities from any Node.js application."
---
...
Import the client and error class from the main entry point. For advanced introspection of route contracts, import from the `/contracts` sub-path:
